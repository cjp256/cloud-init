...
def hash_password(password: str) -> str:
    ...
    If neither are available, raise ReportableErrorMissingDependency.

    :param password: plaintext password to hash.
    :return: The hashed password string.
    :raises ReportableErrorMissingDependency: If crypt and passlib are unavailable.
    """
    try:
    ...
    raise errors.ReportableErrorMissingDependency("passlib")
